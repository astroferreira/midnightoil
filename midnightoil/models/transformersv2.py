...
class WindowAttention(L.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.proj = L.Dense(dim, name="attention_projection")
...
def mlp_block(dropout_rate: float, hidden_units: List[int], name: str = "mlp"):
    ...
    for (idx, units) in enumerate(hidden_units):
        ...
        ffn.add(L.Dropout(dropout_rate))
    return ffn
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not self.pre_logits:
            ...
            self.head = L.Dense(num_classes, activation=act, name="classification_head")
...
def SwinTransformerv2(cfg):
    
    #build model from config file
    net = SwinTransformer(img_size=cfg['input_size'][0], 
